      ...
      },
      {
        ...
        topics: [
          ...
          },
          {
            ...
            difficulty: 0,
            ques_topic:
              '[{"value":"java","label":"Java"},{"value":"basics","label":"Introduction to DSA"}]',
          },
        ],
      },
      {
        ...
        topics: [
          {
            ...
            cs_link:
              "https://www.codingninjas.com/studio/problems/introduction-to-linked-list_8144737?utm_source=striver&utm_medium=website&utm_campaign=a_zcoursetuf",
            lc_link: null,
            company_tags: null,
            difficulty: 0,
            ques_topic:
        ...
        topics: [
          {
            ...
            cs_link:
              "https://www.codingninjas.com/studio/problems/introduction-to-doubly-linked-list_8160413?utm_source=striver&utm_medium=website&utm_campaign=a_zcoursetuf",
            lc_link: null,
            company_tags: null,
            difficulty: 0,
            ques_topic:
    ...
    sub_steps: [
      {
        ...
        topics: [
          ...
          },
          {
            ...
            difficulty: 0,
            ques_topic:
              '[{"value":"stack","label":"Stack"},{"value":"recursion","label":"Recursion"},{"value":"data-structure","label":"Data Structures"}]',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        topics: [
          ...
          },
          {
            ...
            difficulty: 2,
            ques_topic:
              '[{"value":"maths","label":"Maths"},{"value":"string","label":"String"},{"value":"data-structure","label":"Data Structures"}]',
          },
        ],
      },
    ],
      ...
      },
      {
        ...
        topics: [
          ...
          },
          {
            ...
            difficulty: 2,
            ques_topic:
              '[{"value":"arrays","label":"Arrays"},{"value":"dynamic-programming","label":"Dynamic Programming"},{"value":"stack","label":"Stack"},{"value":"data-structure","label":"Data Structures"}]',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        topics: [
          ...
          },
          {
            ...
            difficulty: 1,
            ques_topic:
              '[{"value":"arrays","label":"Arrays"},{"value":"hashing","label":"Hashing"},{"value":"greedy","label":"Greedy"},{"value":"sorting","label":"Sorting"},{"value":"data-structure","label":"Data Structures"}]',
          },
        ],
      },
      {
    ...
    sub_steps: [
      {
        ...
        topics: [
          ...
          },
          {
            ...
            difficulty: 1,
            ques_topic:
              '[{"value":"stack","label":"Stack"},{"value":"string","label":"String"},{"value":"data-structure","label":"Data Structures"}]',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        topics: [
          ...
          },
          {
            ...
            difficulty: 2,
            ques_topic:
              '[{"value":"arrays","label":"Arrays"},{"value":"binary-search","label":"Binary Search"},{"value":"graph","label":"Graph"},{"value":"heap","label":"Heap"}]',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        topics: [
          ...
          },
          {
            ...
            step_title: "Dynamic Programming [Patterns and Problems]",
            sub_step_title: "DP on Subsequences",
            question_title: "0/1 Knapsack (DP - 19)",
            post_link:
      ...
      },
      {
        ...
        topics: [
          ...
          },
          {
            ...
            difficulty: 1,
            ques_topic:
              '[{"value":"data-structure","label":"Data Structures"},{"value":"dynamic-programming","label":"Dynamic Programming"},{"value":"arrays","label":"Arrays"},{"value":"recursion","label":"Recursion"}]',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        topics: [
          ...
          },
          {
            ...
            difficulty: 2,
            ques_topic:
              '[{"value":"arrays","label":"Arrays"},{"value":"dynamic-programming","label":"Dynamic Programming"},{"value":"graph","label":"Graph"},{"value":"data-structure","label":"Data Structures"}]',
          },
        ],
      },
      {
...
function generateHTML(data) {
  let html = "";
  let totalHomeQuestions = 0;
  let totalHomeQuestionsDone = 0;

  data.forEach((step) => {
    html += `<div class="step">
          <h2>${step.step_title}</h2>`;
    step.sub_steps.forEach((subStep) => {
      html += `<div class="sub-step" id="${subStep.sub_step_no}">
              <h3>${subStep.sub_step_title}</h3>`;
      ...
      subStep.topics.forEach((topic) => {
        if (
          ...
          html += `<tr class="topic-row">
                              <td>${topic.question_title}</td>
                              <td class="links">`;
          // Add links
          html += `<ul>`;
          if (topic.post_link)
            html += `<li><a href="${topic.post_link}" target="_blank">Post Link</a></li>`;
          if (topic.yt_link)
            html += `<li><a href="${topic.yt_link}" target="_blank">YouTube Link</a></li>`;
          if (topic.gfg_link)
            html += `<li><a href="${topic.gfg_link}" target="_blank">GeeksforGeeks Link</a></li>`;
          if (topic.cs_link)
            html += `<li><a href="${topic.cs_link}" target="_blank">Coding Ninjas Link</a></li>`;
          html += `</ul>
                          </td>
                          <td class="done-button">
                              <button class="done-btn ${
                                localStorage.getItem(topic.id) === "true"
                                  ? "done"
                                  : "not-done"
                              }" id="${topic.id}">${
            localStorage.getItem(topic.id) === "true" ? "Done" : "Not Done"
          }</button>
                          </td>
                      </tr>`;
          totalHomeQuestions++; // Increment total home questions count
          if (localStorage.getItem(topic.id) === "true") {
            totalHomeQuestionsDone++; // Increment total home questions done count
          }
        }
      });
      html += `</tbody>
  ...
  // Display total home questions done out of all home questions at the top
  const totalDoneText = document.createTextNode(
    `Total Home Questions Done: ${totalHomeQuestionsDone} out of ${totalHomeQuestions}`
  );
  const totalDoneElement = document.createElement("div");
  totalDoneElement.classList.add("total-done");
  totalDoneElement.appendChild(totalDoneText);
...
// Function to save question done state in local storage
function saveQuestionState(questionId, isDone) {
  localStorage.setItem(questionId, isDone);
}

// Function to handle click on done button
function handleDoneButtonClick(event) {
  const button = event.target;
  const questionId = button.id;
  const isDone = button.textContent === "Not Done";
  button.textContent = isDone ? "Done" : "Not Done";
  button.classList.toggle("done");
  button.classList.toggle("not-done");
  saveQuestionState(questionId, isDone);
}
